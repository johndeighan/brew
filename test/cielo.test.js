...
cieloTester.equal(60, `if (x==42)
	console.log x`, `if (x==42)
	console.log x`);

// ---------------------------------------------------------------------------
// --- maintain indentation - complex
cieloTester.equal(71, `x = 42
if (x==42)
	console.log x
	if (x > 100)
...
// ---------------------------------------------------------------------------
cieloTester.equal(182, `import {undef, pass} from '@jdeighan/coffee-utils'
