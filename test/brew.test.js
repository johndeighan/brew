...
export var tester = new BrewTester();
...
/*
	...
	nav
 */
tester.equal(27, 'nav.svelte', `<nav>
</nav>`);
		...
		-
			...
			lItems:
				...
				-
					...
					url: /contact
 */
tester.equal(53, 'heredoc.svelte', `<nav lItems={__anonVar0}>
</nav>
<script>
 ...
 */
tester.equal(118, 'layout.svelte', `<nav>
 ...
 * TopMenuShort.starbucks
	...
	div.main
			...
			nav
 */
tester.equal(189, 'TopMenuShort.svelte', `<div class="main">
	{#if hItem.url}
		<a href={hItem.url}>
		</a>
