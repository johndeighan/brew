...
// ---------------------------------------------------------------------------
starbucksTester.equal(26, `#starbucks webpage

nav`, `<nav>
</nav>`);

// ---------------------------------------------------------------------------
starbucksTester.equal(37, `#starbucks webpage
...
nav lItems={<<<}
	...
	-
		...
		lItems:
			...
			-
				label: Contact
				url: /contact`, `<nav lItems={__anonVar0}>
</nav>
<script>
...
// ---------------------------------------------------------------------------
starbucksTester.equal(79, `#starbucks webpage
...
// ---------------------------------------------------------------------------
starbucksTester.equal(174, `#starbucks component (hItem)
...
// ---------------------------------------------------------------------------
starbucksTester.equal(206, `#starbucks webpage
...
// ---------------------------------------------------------------------------
cieloTester.equal(219, `import {undef, pass} from '@jdeighan/coffee-utils'
